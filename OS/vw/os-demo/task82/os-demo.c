...
void os_demo_mblk_handle(mblk_t *mb)
{
    ...
    unsigned char icmp_type = *(next_header + (ip->version_ihl & 0x0F) * 4);
...
void os_demo_init()
{
    Print("________________________________REYAL(5)_____________________________(0)\n");
}