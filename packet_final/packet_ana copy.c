...
typedef struct {
    ...
    uint16_t identification;
        ...
        uint16_t mf_flag:1;             // More Fragments flag
        uint16_t df_flag:1;             // Don't Fragment flag
        uint16_t reserved_flag:1;       // Reserved flag (must be 0)
        uint16_t frag_offset_low:8;     // Fragment offset field
    #elif __BYTE_ORDER == __BIG_ENDIAN
